...
Row _buildJournalFooterImages() {
  return Row(
    ...
    children: <Widget>[
      CircleAvatar(
        backgroundImage: AssetImage('assets/images/raiden.jpg'),
        radius: 40.0,
      ),
      CircleAvatar(
        backgroundImage: AssetImage('assets/images/raiden1.jpg'),
        radius: 40.0,
      ),
      CircleAvatar(
        backgroundImage: AssetImage('assets/images/raiden2.jpg'),
        radius: 40.0,
      ),
      SizedBox(
        width: 100.0,
